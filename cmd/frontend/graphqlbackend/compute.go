...
func (c *computeMatchContextResolver) Resource() *GitTreeEntryResolver { return c.resource }

func (c *computeMatchContextResolver) Matches() []*computeMatchResolver {
	var result []*computeMatchResolver
...
func (r *computeTextResolver) Resource() *GitTreeEntryResolver { return nil }
...
func NewComputeImplementer(ctx context.Context, args *ComputeArgs) ([]*computeResultResolver, error) {
	return []*computeResultResolver{{&computeTextResolver{&compute.Text{Value: "value"}}}}, nil
}
