...
func NewMockDBStore() *MockDBStore {
	return &MockDBStore{
		...
		InsertCloneableDependencyRepoFunc: &DBStoreInsertCloneableDependencyRepoFunc{
			defaultHook: func(context.Context, semantic.Package) (bool, error) {
				return false, nil
			},
		},
		ReferencesForUploadFunc: &DBStoreReferencesForUploadFunc{
...
type DBStoreInsertCloneableDependencyRepoFunc struct {
	defaultHook func(context.Context, semantic.Package) (bool, error)
	hooks       []func(context.Context, semantic.Package) (bool, error)
...
func (m *MockDBStore) InsertCloneableDependencyRepo(v0 context.Context, v1 semantic.Package) (bool, error) {
...
func (f *DBStoreInsertCloneableDependencyRepoFunc) SetDefaultHook(hook func(context.Context, semantic.Package) (bool, error)) {
	f.defaultHook = hook
}
...
// action.
func (f *DBStoreInsertCloneableDependencyRepoFunc) PushHook(hook func(context.Context, semantic.Package) (bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *DBStoreInsertCloneableDependencyRepoFunc) SetDefaultReturn(r0 bool, r1 error) {
	f.SetDefaultHook(func(context.Context, semantic.Package) (bool, error) {
		return r0, r1
	})
}
...
func (f *DBStoreInsertCloneableDependencyRepoFunc) PushReturn(r0 bool, r1 error) {
	f.PushHook(func(context.Context, semantic.Package) (bool, error) {
		return r0, r1
	})
}

func (f *DBStoreInsertCloneableDependencyRepoFunc) nextHook() func(context.Context, semantic.Package) (bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
