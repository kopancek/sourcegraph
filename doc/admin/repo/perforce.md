...
<span class="badge badge-experimental">Experimental</span> <span class="badge badge-note">Sourcegraph v3.25.1+</span>
...
<span class="badge badge-note">Sourcegraph v3.26+</span>

To enable permissions syncing for Perforce depots, include the `authorization` field:
...
> WARNING: Sourcegraph only supports repository-level permissions and does not match the granularity of [Perforce permissions tables](https://www.perforce.com/manuals/cmdref/Content/CmdRef/p4_protect.html) (notably, [file-level permissions are not supported](#file-level-permissions)). Read on to learn more about the workaround.
...
<span class="badge badge-note">Sourcegraph v3.31+</span>
